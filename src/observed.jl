...
const ODESolutionWithStaticCache{T,N,uType,uType2,EType,tType,rateType,P,A,IType,DE} = OrdinaryDiffEq.ODECompositeSolution{T,N,uType,uType2,EType,tType,rateType,P,A,IType,DE} where P<:ODEProblemWithStaticCache
